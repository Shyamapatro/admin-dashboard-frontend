...
function GetReportBugDetails() {
  ...
  const onGetDetails = (idd) => {
    ...
    ApiServices.reportedBugsDetail(id)
      .then((response) => {
            ...
            <Paper sx={{ mt: 3 }}>
              ...
              <TableBody width="100%">
                  ...
                  <TableCell align="center">Reported By</TableCell>
                    <TableCell align="center" width="90%">{Get.reportedBy}</TableCell>
                  </TableRow>
                  <TableRow>
                  <TableCell align="center">Reported Item</TableCell>
                    <TableCell align="center" width="90%">{Get.reportedItem}</TableCell>
                  </TableRow>
                  <TableRow>
                  <TableCell align="center">Status</TableCell>
                    <TableCell align="center" width="90%">{Get.status}</TableCell>
                  </TableRow>
                  <TableRow>
...
export default GetReportBugDetails;
