...
function GetReportContentDetails() {
  ...
  const onGetDetails = (idd) => {
    ...
    ApiServices.reportedContentDetail(id)
      .then((response) => {
            ...
            <Paper sx={{ mt: 3 }}>
              ...
              <TableBody width="100%">
                  ...
                  <TableCell align="center">Description</TableCell>
                    <TableCell align="center" width="90%">{Get.Description}</TableCell>
                  </TableRow>
                  <TableRow>
...
export default GetReportContentDetails;
