...
function GetAdminAchievement() {
  ...
  const onGetapp = (idd) => {
    ...
    ApiServices.GetAchivementDetails(id)
      .then((response) => {
          ...
          <Box sx={{ mr: 4.2, mt: 2 }} md={12}>
            <Paper sx={{ mt: 3 }}>
              ...
              <TableBody width="100%">
                  ...
                  <TableRow>
                  <TableCell align="center">Achievement Name</TableCell>
                    <TableCell align="center" width="90%">{Get.name}</TableCell>
                  </TableRow>
                  <TableRow>
                  <TableCell align="center">Version</TableCell>
                    <TableCell align="center" width="90%">{Get.Type}</TableCell>
                  </TableRow>
                  <TableRow>
...
export default GetAdminAchievement;
