...
function GetCategoryDetails() {
  ...
  const onGetCategory = (idd) => {
    console.log("rowid", idd);
    ApiServices.CategoryDetail(id)
      .then((response) => {
            ...
            <Paper sx={{ mt: 3 }}>
              ...
              <TableBody width="100%">
                  ...
                  <TableCell align="center">Image</TableCell>
                    <TableCell align="center" width="90%"><img width="50px" height="50px" src={image_path+Get.image} alt="CategoryDetail"/></TableCell>
                  </TableRow>
                  <TableRow>
